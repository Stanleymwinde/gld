...
<body>
 ...
 <div class="container-fluid">
        <!-- Navigation -->
        @include('Inc.nav') <!-- Include the navigation content here -->
                    ...
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            ...
                            <div class="media-body py-md-4">
                                ...
                                <p>Swift transaction: Purchase proposal presented entirely in cash for expedited
                                    property
                                    acquisition.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            ...
                            <div class="media-body py-md-4">
                                ...
                                <p>Trusted professionals providing expert guidance and support for your real estate
                                    journey.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                                <div class="media block-6 services services-2">
                                    <div class="media-body py-md-4 text-center">
                                        ...
                                        <p>Property evaluation involves appraising factors like location, size,
                                            condition,
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 wrap-about py-md-5 ftco-animate">
                        <div class="heading-section p-md-5">
                            ...
                            <p>People are at the heart of our real estate philosophy. We prioritize personalized
                                service,
                                ensuring each client's unique needs are met. Transparent communication and empathetic
                                listening further underscore our commitment to making every real estate journey a
                                positive
                    ...
                    <div class="col-md-12">
                        <div class="carousel-testimony owl-carousel ftco-owl">
                            ...
                            <div class="item">
                                <div class="testimony-wrap py-4">
                                    <div class="text">
                                        <p class="mb-4">Professionalism and warmth define Golden Dream Estate. They
                                            found
                            ...
                            <div class="item">
                                <div class="testimony-wrap py-4">
                                    <div class="text">
                                        <p class="mb-4">Best Company to buy or sell with.My personal Experience with
                                            the

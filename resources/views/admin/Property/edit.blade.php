                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <form class="container" action="{{ route('updateProperty', $property->id) }}"
                                    ...
                                    @endif
                                    <div class="card-body">
                                        <h4 class="card-title">Update this blog with title {{ $property->name }} </h4>
                                        ...
                                        <form class="forms-sample">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="body" id="exampleTextarea1" rows="4" value="{!! $property->body !!}"></textarea>
                                            </div>
                                            @error('body')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
